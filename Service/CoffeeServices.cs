...
namespace Bislerium.Service
{
    public class CoffeeServices
    {
        ...
        {
            List<Coffee> coffeeList = GetCoffeeListFromJsonFile();
            Coffee coffee = coffeeList.FirstOrDefault(coffee => coffee.Id.ToString().Equals(coffeeID));
            return coffee;
        }
        ...
        public void UpdateCofeeDetails(Coffee coffee)
        {
            ...
            Coffee coffeeToUpdate = coffeeList.FirstOrDefault(_coffee => _coffee.Id.ToString().Equals(coffee.Id.ToString()));
